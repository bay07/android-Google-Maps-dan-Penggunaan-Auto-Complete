...
import com.example.Bismillah.response.ResponseRoute;
import com.example.Bismillah.R;
import com.example.Bismillah.network.ApiServices;
import com.example.Bismillah.network.InitLibrary;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String API_KEY = "AIzaSyDjnj_E_lx80CyDIfoglUC4Nzdy5bwMMeE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aplikasi Login & Maps");
                 ...
                 //   Distance dataDistance = dataLegs.getDistance();
                  ...
                  latLongBuilder.include(pickUpLatLng);
                   ...
                   // int width = getResources().getDisplayMetrics().widthPixels;
                    ...
                    int paddingMap = (int) (0.2); //jarak dari
